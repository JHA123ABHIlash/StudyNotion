...
//                             <div className='flex h-full flex-col gap-3 rounded-lg border border-richblack-700 bg-richblack-800 p-4 text-[14px] text-richblack-25'>
...
//     </span>
//     <RatingStars Review_Count={review?.rating || 0} Star_Size={20} />
// </div>
//                             </div>
//                         </SwiperSlide>
//                     ))
